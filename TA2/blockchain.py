...
class Block:
    ...
    def mineBlock(self):
        ...
        # Set the nonce limit instead of mining limit (set lower limit to see if code works fine)
        # miningLimit = 30000
        nonceLimit = 1000
        ...
        while self.currentHash[:self.difficulty] != target:
            ...
            # Replace the attempts with self.nonce and miningLimit with nonceLimit
